...
#
"""Supervised Fine-Tuning for telco COBOL-to-text models.
...
@StageRegistry.register(recipe="telco", workflow="sft", stage="training")
class SFTStage(BaseStage):
    """Supervised fine-tuning on telco COBOL-to-text data.
